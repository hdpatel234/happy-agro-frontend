  ...
  return (
    <div className="eex-container">
      <div className="eex-card">
        ...
        <h2 className="eex-title">Edit Expense</h2>
        ...
        <div className="eex-form-row">
          <div className="eex-form-group">
            ...
            <span className="eex-helper-text">Or enter custom category below</span>
          </div>
          <div className="eex-form-group">
        ...
        <div className="eex-footer-actions mt-24">
          ...
          <Link href="/expenses" className="btn eex-btn-gray eex-action-btn">Cancel</Link>
        </div>
      </div>
    </div>
  );
